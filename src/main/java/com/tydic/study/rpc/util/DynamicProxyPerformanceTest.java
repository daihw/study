...
public class DynamicProxyPerformanceTest {  
    ...
    private static CountService createJdkDynamicProxy(final CountService delegate) {  
        ...
        //ProxyUtils.generateClassFile(jdkProxy.getClass(), "c");
        return jdkProxy;  
    }  
    ...
    private static CountService createCglibDynamicProxy(final CountService delegate) throws Exception {  
        ...
        ProxyUtils.generateClassFile(cglibProxy.getClass(), "b");
        return cglibProxy;  
    }  
    ...
    private static CountService createJavassistDynamicProxy(final CountService delegate) throws Exception {  
        ...
        ProxyUtils.generateClassFile(javassistProxy.getClass(), "a");
    ...
    private static CountService createJavassistBytecodeDynamicProxy(CountService delegate) throws Exception {  
        ...
        mCtc.writeFile("CountServiceJavaassistProxy.class");
        //InputStream input = pc.getResourceAsStream("com.alibaba.test.performance.dynamicproxy.CountServiceJavaassistProxy.class");
        //System.out.println("cccc"+input);
        //FileOutputStream fos = new FileOutputStream("JavaassistProxy.class");  
        //fos.write(code);  
        //fos.close(); 
